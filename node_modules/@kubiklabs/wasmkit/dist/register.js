...
const wasmkit_params_1 = require("./internal/core/params/wasmkit-params");
...
async function registerEnv() {
    ...
    const runtimeArgs = (0, env_variables_1.getEnvRuntimeArgs)(wasmkit_params_1.WASMKIT_PARAM_DEFINITIONS, process.env);
