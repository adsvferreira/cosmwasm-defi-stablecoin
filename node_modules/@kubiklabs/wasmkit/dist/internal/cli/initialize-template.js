...
async function checkTemplateExists(basePath, templateName) {
    ...
    if (fs_extra_1.default.existsSync(templatePath)) {
        ...
        console.log(chalk_1.default.red(`Error occurred: template "${templateName}" does not exist in ${constants_1.TEMPLATES_GIT_REMOTE}`));
...
async function initialize({ force, projectName, templateName, destination }) {
    ...
    console.info(`* Fetching templates from ${constants_1.TEMPLATES_GIT_REMOTE} *`);
    await (0, fetch_1.fetchRepository)(constants_1.TEMPLATES_GIT_REMOTE, tempDirPath);
    if (templateName === undefined) {
        console.log(`Template name not passed: using default template ${chalk_1.default.green(constants_1.DEFAULT_TEMPLATE)}`);
        templateName = constants_1.DEFAULT_TEMPLATE;
    }
    let templatePath;
