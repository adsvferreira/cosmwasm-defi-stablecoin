...
exports.string = {
    ...
    validate: (argName, value) => {
        ...
        if (!isString) {
            throw new errors_1.WasmkitError(errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE, {
                value,
                name: argName,
...
exports.inputFile = {
    ...
    parse(argName, strValue) {
        try {
            ...
            throw new errors_1.WasmkitError(errors_list_1.ERRORS.ARGUMENTS.INVALID_INPUT_FILE, {
                name: argName,
                value: strValue
            }, error);
        }
...
exports.json = {
    ...
    parse(argName, strValue) {
        try {
            ...
            throw new errors_1.WasmkitError(errors_list_1.ERRORS.ARGUMENTS.INVALID_JSON_ARGUMENT, {
                param: argName,
                error: error.message
            }, error);
        }
