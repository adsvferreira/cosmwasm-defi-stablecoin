...
function paramNameToEnvVariable(paramName) {
    ...
    return arguments_parser_1.ArgumentsParser.paramNameToCLA(paramName)
        .replace(arguments_parser_1.ArgumentsParser.PARAM_PREFIX, WASMKIT_ENV_ARGUMENT_PREFIX)
        .replace(/-/g, "_")
        .toUpperCase();
}
    ...
    for (const paramName of (0, unsafe_1.unsafeObjectKeys)(paramDefinitions)) {
        ...
        if (rawValue !== undefined) {
            try {
                ...
                throw new errors_1.WasmkitError(errors_list_1.ERRORS.ARGUMENTS.INVALID_ENV_VAR_VALUE, {
                    varName: envVarName,
                    value: rawValue
                }, error);
            }
