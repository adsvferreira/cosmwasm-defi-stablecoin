...
You can learn how to use WasmKit by reading the [Getting Started guide](../getting-started).`,
        ...
        INVALID_NODE_VERSION: {
            number: 2,
            message: "WasmKit doesn't support your Node.js version. It should be %requirement%.",
...
Please [report it](https://github.com/kubiklabs/wasmkit/issues/new) to help us improve WasmKit.`,
        ...
        CONTEXT_PRE_NOT_DEFINED: {
            number: 6,
            message: 'WasmKit Runtime Environment is not defined in the WasmkitContext.',
...
Please [report it](https://github.com/kubiklabs/wasmkit/issues/new) to help us improve WasmKit.`,
        ...
        CONTEXT_PRE_ALREADY_DEFINED: {
            number: 7,
            message: 'WasmKit Runtime Environment is already defined in the WasmkitContext',
...
Please [report it](https://github.com/kubiklabs/wasmkit/issues/new) to help us improve WasmKit.`,
        ...
        NON_LOCAL_INSTALLATION: {
            number: 12,
            message: 'Trying to use a non-local installation of WasmKit, which is not supported.\nPlease install WasmKit locally using npm or Yarn, and try again.',
...
Read the [documentation](https://WasmKit.org/config/#networks-configuration) to learn how to define custom networks.`,
        ...
        INVALID_GLOBAL_CHAIN_ID: {
            number: 101,
            message: 'WasmKit was set to use chain id %configChainId%, but connected to a chain with id %connectionChainId%.',
...
Try using another mnemonic or deriving less keys.`,
        ...
        UNKNOWN_NETWORK: {
            number: 112,
            message: "Network not supported with %account%.",
        ...
        UNKNOWN_LOCAL_NETWORK: {
            number: 113,
            message: "Local network %nodeType% not found in wasmkit.config.js file.",
...
Please double check your task definitions.`,
        ...
        PARAM_CLASHES_WITH_WASMKIT_PARAM: {
            number: 202,
            message: 'Could not set param %paramName% for task %taskName% because its name is used as a param for WasmKit.',
...
You must always use slashes (/) in Solidity imports.`,
        ...
        INVALID_IMPORT_PROTOCOL: {
            number: 406,
            message: "Invalid import %imported% from %from%. WasmKit doesn't support imports via %protocol%.",
...
You can only import files thar are available locally or installed through npm.`,
        ...
        INVALID_IMPORT_ABSOLUTE_PATH: {
            number: 407,
            message: "Invalid import %imported% from %from%. WasmKit doesn't support imports with absolute paths.",
...
We recommend not using this kind of dependencies.`,
        ...
        JSONRPC_UNSUPPORTED_NETWORK: {
            number: 605,
            message: 'Unsupported network for JSON-RPC server. Only WasmKit is currently supported.',
