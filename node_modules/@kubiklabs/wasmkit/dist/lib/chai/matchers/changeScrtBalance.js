...
accountAddr, includeFee, logResponse) {
    ...
    const balanceBefore = extractScrtBalance(await (0, client_1.getBalance)(client, accountAddr, env.network));
    ...
    const balanceAfter = extractScrtBalance(await (0, client_1.getBalance)(client, accountAddr, env.network));
    const fees = Object.assign(Object.assign({}, constants_1.defaultFees), (context_1.WasmkitContext.getWasmkitContext().getRuntimeEnv().network.config.fees ?? {}));
    if (includeFee !== true &&
