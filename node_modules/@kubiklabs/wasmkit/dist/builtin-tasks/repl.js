...
const wasmKit = __importStar(require("../index"));
...
async function startConsole(runtimeEnv) {
    await new Promise((resolve, reject) => {
        console.log("★★★", chalk_1.default.blueBright(" Welcome to WasmKit REPL"), "★★★");
...
function default_1() {
    (0, config_env_1.task)(task_names_1.TASK_REPL, "Opens WasmKit console")
