...
async function run() {
    ...
    //------------------ UNAUTHORIZES ERROR ON MINTING - CHECK CW20 docs
    ...
    const deposit_collateral_and_mint_dsc_res = await dsce_contract.depositCollateralAndMintDsc({ account: contract_owner }, {
