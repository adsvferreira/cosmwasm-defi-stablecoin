import { getAccountByName, Coin } from "@kubiklabs/wasmkit";

import { DscContract } from "../artifacts/typescript_schema/DscContract";
...
export default async function run () {
  ...
  const stable_cw20_contract = new DscContract();
